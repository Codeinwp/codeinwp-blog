...
class newsletter_widget extends WP_Widget {
    ...
    function widget( $args, $instance ) {
        ...
        <form action="https://codeinwp.us3.list-manage.com/subscribe/post?u=bf06b9a7223d1c8f65272caf7&amp;id=bd98fdaf54" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate cf" target="_blank" novalidate>
