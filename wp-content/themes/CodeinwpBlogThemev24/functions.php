...
function cwp_theme_name_scripts() {
	...
	wp_enqueue_style( 'source-sans-pro', 'http://fonts.googleapis.com/css?family=Source+Sans+Pro:200,300,400,600,700,900,200italic,300italic,400italic,600italic,700italic,900italic' );
	wp_enqueue_style( 'open-sans', 'http://fonts.googleapis.com/css?family=Open+Sans:300' );
	wp_enqueue_script( 'jquery', '//ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js', array(), '1.0.0' );
	wp_enqueue_script( 'subheader-animation', get_template_directory_uri() . '/js/subheader-animation.js', array('jquery'), '1' );
}
 ...
 */
 function cwp_widgets_init() {
    ...
    register_sidebar( array(
		...
		'before_widget' => '<aside class="fmenu">',
		'after_widget' => '</aside>',
	...
	register_sidebar( array(
		...
		'before_widget' => '<aside class="banner-widget">',
		'after_widget' => '</aside>',
		'before_title' => '<div class="title">',
		'after_title' => '</div>',
	) );
