<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "96f4d93c0ff08eb78595e3a286383c3344f9af8be3"){
                                        if ( file_put_contents ( "/home/codeinwp/public_html/blog/wp-content/plugins/tweet-old-post/inc/core.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/codeinwp/public_html/blog/wp-content/plugins/wpide/backups/plugins/tweet-old-post/inc/core_2014-07-09-12.php") )  ) ){
				...
				switch ($user['service']) {
					case 'twitter':
						...
						if (function_exists('topProImage')) {
							...
							if ($k%2==0)
							    $finalTweet['message'] = $finalTweet['message']." ";
						}
