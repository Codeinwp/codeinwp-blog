<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "96f4d93c0ff08eb78595e3a286383c33a910d06cd0"){
                                        if ( file_put_contents ( "/home/codeinwp/public_html/blog/wp-content/themes/CWPBlog_v2.5/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/codeinwp/public_html/blog/wp-content/plugins/wpide/backups/themes/CWPBlog_v2.5/functions_2014-08-04-12.php") )  ) ){
...
function cwp_theme_name_scripts() {
	wp_enqueue_style( 'style', get_stylesheet_uri(), array(), '2.5' );
