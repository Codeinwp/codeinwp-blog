<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "96f4d93c0ff08eb78595e3a286383c3368e9a144cf"){
                                        if ( file_put_contents ( "/home/codeinwp/public_html/blog/wp-content/themes/CodeinwpBlogThemev24/header.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/codeinwp/public_html/blog/wp-content/plugins/wpide/backups/themes/CodeinwpBlogThemev24/header_2014-05-23-11.php") )  ) ){
...
<head>
	...
	<link rel="icon" type="image/png" href="<?php echo get_template_directory_uri(); ?>/cwpfavicon.png">
	<?php wp_head(); ?>
</head>
<body <?php body_class(); ?>>
