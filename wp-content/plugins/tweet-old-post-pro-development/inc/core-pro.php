...
if (!class_exists('CWP_TOP_Core_PRO')) {
	class CWP_TOP_Core_PRO  {
		...
		function download_file(){
			$prov = get_plugin_data(ROPPLUGINPATH."/tweet-old-post.php");
			if(version_compare($prov['Version'],"6.8.4","<=")){

				$this->notices[] =  "You need to have the latest version of the Revive Old Post Pro plugin in order to have the updated features available !";
			}
